...
\begin{dot2tex}[dot,scale=0.2]
digraph UML {
  d2tstyleonly = true;
  node [shape = "box", width = "8", texmode="math", style = "top color=cyan!10,bottom color=cyan!35,draw=cyan!50,rounded corners"];
  ...
  nodeSprite [label="Struct Sprite\n
    ...
    (Vec<(Posture, [[(Emotion, Part); MAX_X]; MAX_Y])>)
	{}
    + new(sheet: Vec<(Posture, [[(Emotion, Part); MAX_X]; MAX_Y])>) => Result<Self>
  "];
